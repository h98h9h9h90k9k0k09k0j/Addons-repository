...
gst-launch-1.0 v4l2src device=/dev/video0 ! image/jpeg,framerate=30/1 ! videoconvert ! v4l2h264enc ! rtph264pay config-interval=1 ! gdppay ! tcpserversink host=0.0.0.0 port=8080 
